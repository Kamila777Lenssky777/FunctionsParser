...
import ru.ifmo.ctddev.Romashchenko.calc.io.Function;

/**
 * parser for math modeling
 * @author I
 */
public class ParserOfFunctions {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) throws EvaluationException {
        //System.out.println("a = " + new Function().equals(null));
    ...
    public static void tabulationOfFunction(RPR rpr) {
        ...
        for (int i = 0; i <= 10; i++) {
            System.out.print(i + "\t");
            try {
                System.out.println(formula.evaluate((double)i));
